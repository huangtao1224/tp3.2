<?php if (!defined('THINK_PATH')) exit(); require APP_ROOT.'public/top.php'; $type_id = pg('type_id'); ?>
        ...
        <div class="right_data">
            ...
            <form method="post" id="form_menu" action="admin.php?m=input&a=batch_edit_save" class="white table_form">
                ...
                <table class="table">
                    ...
                    <?php
 $list = M('input')->where(array('type_id'=>$type_id,'input_pid'=>array('EXP','IS NULL')))->order('date asc')->select(); foreach($list as $k=>$v){ ?>
                    <tr class="row_list2">
 ...
 $input_type = M('input_type')->where(array('input_type_id'=>$v['input_type_id'],'is_parent'=>2))->select(); if(!empty($input_type)){ ?>
                        ...
                        <td>
                            <select name="data[input_type_id][]">
                                <?php
 $list2 = M('input_type')->select(); foreach($list2 as $k2=>$v2){ ?>
                        ...
                        <td>
                            <select name="data[data_type_id][]">
                                <?php
 $list2 = M('data_type')->select(); foreach($list2 as $k2=>$v2){ ?>
