                        ...
                        <div class="tabconent_row_input">
                            <select name="data[classify_pid]" id="classify_pid">
                                ...
                                function recursive_classify($classify_pid='1')
                                {
                                    ...
                                    foreach($lists as $k=>$v)
                                    {
                                        if($user['permissions']==3){
                                            if($v['classify_id']==$classify_pid&&$v['classify_pid']==1){?>
                                ...
                                if($user['permissions']!=3){
                                    ...
                                    $classify_add2 =  M('permission')->where(array('user_id'=>$user['user_id'],'permission_name'=>2,'classify_id'=>array('neq','')))->order('classify_id asc')->select();
                                    foreach ($classify_add2 as $k2=>$v2){
                                        $recursive2=recursive_classify_id($v2['classify_id'],2)==''?2:recursive_classify_id($v2['classify_id'],2);
                                        recursive_classify($recursive2);
                                    }
                                }
                                ?>
                            </select>
