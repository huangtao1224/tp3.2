...
class weixinAction extends Action {
	...
	private $appid='wx0b2f1bb78b68bbf6';

	private $appsecret='7cdc4311e67c54ea3a88f923d497621f';
...

	{
		...
		$data=array('appid'=>'wx0b2f1bb78b68bbf6','secret'=>'7cdc4311e67c54ea3a88f923d497621f','code'=>$code,'grant_type'=>'authorization_code');

		$httpstr = curl_http($url, $data, 'GET', array("Content-type: text/html; charset=utf-8"));

		$httpstr_arr=object_array(json_decode($httpstr));

		session('openid',$httpstr_arr['openid']);
	?>
		<!-- 微信支付 -->
		
		<form action="http://<?php echo $_SERVER['HTTP_HOST'];?>/index.php/wxpay/pay/" method="post" id="wxform" name="form">

			<input type="hidden" name="order_id" id="order_id" value="<?php echo $state;?>" />
